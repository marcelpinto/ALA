...
public class Preference {
	...
	public static final String POS_LON 		= "POS_LON";
	public static final String DEST_LAT		= "DLAT";
	public static final String DEST_LON 	= "DLON";
	public static final String ALARM_ACT 	= "ALARM";
	public static final String DEST_METERS 	= "DMETERS";
	public static final String SOUND 		= "SOUND";
	public static final String VIBRATION	= "VIB";
	public static final String RINGTONE 	= "RING";
